    ...
    <section id="certifications" className="section-anchor relative py-24">
      ...
      <div className="mx-auto max-w-6xl px-5">
        <SectionHeading
          ...
          title={
            <>
              Credentials that back my{" "}
              <span className="gradient-text">engineering practice</span>.
            </>
          }
          description="Verified learning across deep learning, NLP, computer vision, and the full-stack AI toolchain."
        />
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {certifications.map((cert, i) => (
            <motion.div
              ...
              className="glass glow-border group relative flex flex-col overflow-hidden rounded-2xl p-5 transition-transform duration-300 hover:-translate-y-1"
            >
              ...
              {cert.url && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="relative mt-4 inline-flex items-center gap-1 text-xs font-medium text-violet-300 hover:text-violet-200"
                >
                  View certificate
